...
const i18n = {
  en: {
    ...
    'cs3.context.callout1': 'The signal was already there. A high volume of support tickets, no support for free subscriptions, no way to tell a usability problem from a missing feature. My job was to build the process to read that signal, and then act on it.',
    ...
    'cs3.research.p1': 'The research goal was exploratory. I wanted to understand how each user type thought about their work, what they needed from the platform, and where the experience was breaking down. I used three methods, each chosen for a specific purpose.',
